...
import com.gwz.bean.KWORD_T_MALL_SKU;
...
import com.gwz.util.MyCacheUtil;
import com.gwz.util.MyHttpGetUtil;
...
public class ListController {
	...
	// public String get_list_by_attr1(@RequestParam("param_array[]") String[]
	// param_array, ModelMap map) {
	//
	// //如果字符串数组，需要切割字符串，并且转换类型
	//
	// return "skuList";
	// }
	@Autowired
	...
	public String keywords(String keywords, ModelMap map) {
		...
		List<KWORD_T_MALL_SKU> list_sku = MyJsonUtil.json_to_list(doGet, KWORD_T_MALL_SKU.class);
